        ...
        "monthly_data": {
            ...
            date(2023, 12, 1): {
                ...
                "payments": [
                    ...
                    {"customer_id": "growth_001", "payment_date": date(2024, 2, 12), "amount": 15500},
                    {"customer_id": "growth_001", "payment_date": date(2024, 3, 12), "amount": 14800},
                    {"customer_id": "growth_001", "payment_date": date(2024, 4, 12), "amount": 15200},
                    {"customer_id": "growth_002", "payment_date": date(2023, 12, 18), "amount": 22000},
                    {"customer_id": "growth_002", "payment_date": date(2024, 1, 18), "amount": 21500},
                    {"customer_id": "growth_002", "payment_date": date(2024, 2, 18), "amount": 22800},
                    {"customer_id": "growth_002", "payment_date": date(2024, 3, 18), "amount": 22200},
                ],
            },
            date(2024, 1, 1): {
                "spend": {"amount": 342000},
                ...
                "payments": [
                    ...
                    {"customer_id": "growth_004", "payment_date": date(2024, 3, 25), "amount": 28800},
                ],
            },
            date(2024, 2, 1): {
                "spend": {"amount": 325000},
                "trade": {"sharing_percentage": 0.30, "cash_cap": 400000.0},
                "payments": [
                    ...
                    {"customer_id": "growth_006", "payment_date": date(2024, 2, 20), "amount": 19500},
                    {"customer_id": "growth_006", "payment_date": date(2024, 3, 20), "amount": 19000},
                    {"customer_id": "growth_006", "payment_date": date(2024, 4, 20), "amount": 20000},
                ],
            },
            date(2024, 3, 1): {
                "spend": {"amount": 358000},
                "trade": {"sharing_percentage": 0.32, "cash_cap": 450000.0},
                "payments": [
            ...
            date(2024, 4, 1): {
                "spend": {"amount": 310000},
                "trade": {"sharing_percentage": 0.29, "cash_cap": 385000.0},
                "payments": [
